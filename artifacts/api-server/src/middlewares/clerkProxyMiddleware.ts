/**
 * Clerk's production frontend API proxy. It is intentionally inactive in
 * development because Clerk development instances use their direct FAPI.
 */
  ...
  return createProxyMiddleware({
    ...
    on: {
      ...
      proxyRes: (proxyRes, req, res) => {
        ...
        if (headers["content-length"] !== undefined || req.method === "HEAD" || status < 200 || status === 204 || status === 304) {
